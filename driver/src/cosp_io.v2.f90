...
contains
  ...
  subroutine construct_cospOutList(Lpctisccp,Lclisccp,Lboxptopisccp,Lboxtauisccp,        &
                                   ...
                                   LcfadDbze94,Ldbze94,Lparasolrefl,Ltbrttov,Ltauclara,  &
                                   Lpctclara,Ltctclara,Lhctclara,Lreffclwclara,          &
    ...
    if (Ltauclara)         out_list(64) = 'tauclara'
    if (Lpctclara)         out_list(65) = 'pctclara'
    if (Ltctclara)         out_list(66) = 'tctclara'
    if (Lhctclara)         out_list(67) = 'hctclara'
    if (Lreffclwclara)     out_list(68) = 'reffclwclara'
    if (Lreffcliclara)     out_list(69) = 'reffcliclara'
    if (Lcltclara)         out_list(70) = 'cltclara'
    if (Llwpclara)         out_list(71) = 'lwpclara'
    if (Liwpclara)         out_list(72) = 'iwpclara'
    if (Lclclara)          out_list(73) = 'clclara'
