...
if (c=6)
'set z 1'
'nrm=sum(sum(sum(cfed,z=1,z=4),x=1,x=35),y=1,y=80)'
'var=sum(cfed,z=1,z=4)/nrm/'xwid'/'ywid
...
'draw string 5.5 7.5 PDF Ze-Vd 'RGN.r' 'TYP.c

'gxprint ./figure/EC_pdf2_ZeVd_'RGN.r'_'TYP.c'.eps'
