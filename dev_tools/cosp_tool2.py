##############################################################################################
#
# The purpose of this program is to compare COSP simulator data. The user provides the locations
# of the datasets to compare and the variables in which to plot.
#
